...
func TestIsGasTownRuntimePath(t *testing.T) {
	tests := []struct {
		...
		{"pkg/.ruff_cache/0.9.0/123", true},
		{"coverage/lcov.info", true},
		{"web/htmlcov/index.html", true},
		{"beads.db", true},
		{"data/beads.db", true},
		...
		},
		{
			...
			s: UncommittedWorkStatus{
				...
				UntrackedFiles: []string{
					...
					"pkg/.mypy_cache/3.12/mod.meta.json",
					"pkg/.ruff_cache/0.9.0/123",
					"coverage/lcov.info",
					"htmlcov/index.html",
					"cache/beads.db",
					"cache/beads.db-wal",
